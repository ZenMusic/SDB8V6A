...
namespace SymbolDB
{
    public partial class Movies2 : Form
    {
        ...
        public Movies2(GlobalVars g, TraverserDialog parent, bool onErrContinueFlag = false, string fpath = null) // main
        {
            InitializeComponent();
            AddMediaPlayer2();
            ...
            SetTitleBar(fpath1);
            //axWindowsMediaPlayer1.PlayStateChange += wmPlayer_PlayStateChange;
        ...
        private void axWindowsMediaPlayer1_MediaError(object sender, AxWMPLib._WMPOCXEvents_MediaErrorEvent e)
        {
            ...
            // In case pMediaObject is not an IWMPMedia item.
            {
                ...
                pTraverser.ErrorDisplay($"Error x Media Error showing error {ex}");
                //dmcdmc this.Close();
            }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                if (!bLockSmallScreen && bZoomFullScreenOnTimer)
                    zoomFullScreen(true);
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData) /////// override dmcdmc123
        {
            ...
            {
                if (pTraverser != null)
                    pTraverser.nextMovie();
            }
            else
            {
                setFocusOnParent2(true);
            }
            return rc;
        }
...
//          this.axWindowsMediaPlayer1.EndOfStream += new AxWMPLib._WMPOCXEvents_EndOfStreamEventHandler(AxWindowsMediaPlayer1_EndOfStreamthis.axWindowsMediaPlayer1_EndOfStream);
            this.axWindowsMediaPlayer1.EndOfStream += new AxWMPLib._WMPOCXEvents_EndOfStreamEventHandler(AxWindowsMediaPlayer1_EndOfStream);
