...
//        <a href="http://www.hyperlinkcode.com"><img src="http://hyperlinkcode.com/images/sample-image.gif"></a> 
        ...
        public Image downloadImage(string url)
        {
          ...
          //  wc.DownloadFile(url);//"http://www.davidmcclanahan.com/images/david2tn.jpg", "c:/david.jpg");

            try
            {
                byteArray = webClient.DownloadData(url);//"http://www.davidmcclanahan.com/images/david2tn.jpg");
            }
            catch (Exception)
            {
        ...
        public string downloadFile(string url)
        {
            ...
            string ts = timestamp.ToUniversalTime().ToLongTimeString();
            Boolean rc = true;

            ts = timestamp.ToOADate().ToString();

            ts = ts.Replace(".", "");
            try
            {
                webClient.DownloadFile(url, targetDirectory + ts + ".jpg");//"http://www.davidmcclanahan.com/images/david2tn.jpg", "c:/david.jpg");
            }
            catch (Exception)
            {
                rc = false;
            ...
            if (rc)
            {
                try
                {
                    this.pictureBox2.Load(targetDirectory + ts + ".jpg");
