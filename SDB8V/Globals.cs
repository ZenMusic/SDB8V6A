...
namespace SymbolDB
{
    ...
    public class ARGS
    {
        ...
        public string[] extensions;        // The actual extensions to search for

        // Keep these for backward compatibility if needed, but make them optional
    ...
    public class GlobalVars
    {
        ...
        public bool webpConverionMode = false;

        // Add inside the GlobalVars class:
        public bool webpConversionMode { get; set; } = false;
        ...
        public string logFilePath = System.IO.Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments),
            "_dazen",
            "SymbolDB.log"
        );

        public bool logErrors = false;  // Also add this if it's missing

        public int traverserBGversion = 1;
        // <summary>
        //
        ...
        //----------------------INIT FILE ----------------//
        static public string initFileName = "sdb8.xml";
        static public string companyFolderName = "_dazen";
        static public string historyFileName = "historyFolderList.xml";
        public string appName = "SymbolDB8v6"; //
        public bool bRunningInDevelopment = false;

        static public string mydocsFolder = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
        //C:\Users\davidmc\documents
        // when debugging intent is C:\Users\davidmc\documents\_dazen\SDB8v6\sdb8.xml
        static public string appDataFolder = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
        //C:\Users\davidmc\AppData\Roaming\SymbolDB\Config\sdb8.xml

        public string inifileFullPathName;  // NOT STATIC 
        public string dataFolder;  // NOT STATIC 
        public string mySDB5notes1 = "SDBdmc1.txt"; // personalized
        public string notesBaseName = "dmc"; // personalized

        public string targetFolder = null; // NOT STATIC target folder for copy or move operations
        public string folderHistoryFileFullPathName; // NOT STATIC
        public string dirDeletedFolder; 

        //static public string initFileName = "\\sdb8.xml";
        //static public string dataFolderName = "\\_dazen";
        public string historyFileNameIs = "historyFolderList.xml";
        //  static public string mydocsFolder = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
        ...
        public string testSourceFolder = @"C:\Users\davidmc\Documents\AA_test_files_SDBv4\testSource";
        public bool useTestSourceAndTargetFolder = false;

        public string ratingsVideos = "ratingVideos.xml";
        public string ratingsImages = "ratingImages.xml";
        //  public InitParms[] initParms;
        public int parmsCount = 0;
        public int MAX_PARMS = 10;
        public int SECONDS_TO_CONTINUE = 10;

        public Boolean showMatchPercentage = false;
        ...
        public int copyAllReturnCode = 0;
        ...
        public bool bAllowDeleteWithControlClick = false; // global flag to enable/disable Ctrl+click delete
        ...
        public string lastLoadedImageFile = null;
        public ImageFileList imageFileListHolding;
        public ImageFileList imageFileList2;
        public ImageFileList imageFileErrorList;
        public ImageFileList imageFileListSearch;
        public ImageFileList deleteFileList1;
        public ImageFileList imageFileListMatches;

        public ImageFileList imageFileListCompare;
        public Boolean bImageFileList1Loaded = false;
        public Boolean bImageFileList2Loaded = false; //dmc26
        ...
        public DialogTraverser dialogTraverser1;
        public DialogTraverser dialogTraverser2;
        public SearchForMediaByName searchWin3;
        ...
        public string dirDialog(InitFolder startFolder, string specialPath = null, string myFilePath = null)
        {
            ...
            if (string.IsNullOrEmpty(myFilePath))
            {
                ...
                {
                    directoryPromptDialog1.RootFolder = Environment.SpecialFolder.MyComputer;
                    directoryPromptDialog1.SelectedPath = dataFolder;
                }
        ...
        //(string joinedExtensions, List<string> extensionList) = SearchExtensionsHelper.GetSearchExtensionValues(globalVars, searchExtensionName);

        public string customSearchExtensions = "*.*"; // user-defined, e.g. "*.avif, *.tiff"

        public Dictionary<string, string[]> SearchExtensions = new Dictionary<string, string[]>(StringComparer.OrdinalIgnoreCase);
/*
{
    { "images",      new[] { "*.jpg", "*.png", "*.bmp", "*.jpeg" } },
    { "images+",     new[] { "*.jpg", "*.png", "*.bmp", "*.jpeg", "*.webp", "*.avif" } },
    { "videos",      new[] { "*.mp4", "*.wmv", "*.mov" } },
    { "videos_webm", new[] { "*.webm", "*.webp" } },
    { "midi",        new[] { "*.mid", "*.mpe" } },
    { "html",        new[] { "*.htm*", "*.html", "*.mhtml" } },
    { "all",         new[] { "*.*" } },
    { "custom",      new[] { "*.*" } }   // overwritten at runtime by PromptCustomExtension()
};*/
    }
}
